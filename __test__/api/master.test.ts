...
describe('Post Master Bank', () => {
  test('Success, With Logo', async () => {
    const { status, headers, body } = await postMasterBank(server, {});
...
describe('Update Master Bank Detail', () => {
  test('Success', async () => {
    const bankId = '0';
    const token = 'this.is.token';
...
describe('Post Master Bank Step', () => {
  ...
  test('Fail, API Key Not Given', async () => {
    ...
    const { status, headers, body } = await postMasterBankStep(server, bankId, {});
...
describe('Delete Master Bank Step', () => {
  test('Success', async () => {
    ...
    const { status, headers, body } = await deleteMasterBankStep(server, bankId, token);
  ...
  test('Fail, API Key Not Given', async () => {
    ...
    const { status, headers, body } = await deleteMasterBankStep(server, bankId);
