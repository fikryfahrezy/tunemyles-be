...
export class m_products
  ...
  setU_products!: Sequelize.HasManySetAssociationsMixin<u_product, u_productId>;
  addU_product!: Sequelize.HasManyAddAssociationMixin<u_product, u_productId>;
  addU_products!: Sequelize.HasManyAddAssociationsMixin<u_product, u_productId>;
  ...
  hasU_products!: Sequelize.HasManyHasAssociationsMixin<u_product, u_productId>;
    ...
    m_products.init(
      {
        ...
        description: {
          ...
          validate: {
            customValidator(value: string) {
              if (value === "")
                throw new Error("product description can't be empty");
            },
            len: {
              args: [2, 1000],
